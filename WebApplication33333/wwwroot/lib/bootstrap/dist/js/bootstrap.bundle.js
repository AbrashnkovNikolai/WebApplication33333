...
(function (global, factory) {
  ...
  const getSelector = element => {
    ...
    if (!selector || selector === '#') {
      let hrefAttr = element.getAttribute('href'); // The only valIdcontent that could double as a selector are IDs or classes,
  ...
  function getDocumentRect(element) {
    ...
    var body = (_element$ownerDocumen = element.ownerDocument) == null ? voId0 : _element$ownerDocumen.body;
  ...
  */
  ...
  function listScrollParents(element, list) {
    ...
    var isBody = scrollParent === ((_element$ownerDocumen = element.ownerDocument) == null ? voId0 : _element$ownerDocumen.body);
      ...
      var instance = {
        ...
        forceUpdate: function forceUpdate() {
          ...
          var _state$elements = state.elements,
              ...
              popper = _state$elements.popper; // Don't proceed if `reference` or `popper` are not valIdelements
          // anymore
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API$1, SELECTOR_DATA_TOGGLE$1, function (event) {
    ...
    }); // avoIdconflict when clicking a toggler of an offcanvas, while another is open
